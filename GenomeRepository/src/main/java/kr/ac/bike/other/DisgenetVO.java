...
// 필요한 속성들... DB column name과 동일하게.
	...
	public String getProtein_class() {
	...
	public void setDisease_class_name(String disease_class_name) {
		this.disease_class_name = disease_class_name;
	}
